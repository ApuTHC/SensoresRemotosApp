package com.example.sensoresremotosapp;
...
import com.example.sensoresremotosapp.databinding.FragmentGuardadasBinding;
import com.example.sensoresremotosapp.ui.slideshow.ElementoFormato;
...
//                                    checkbox1.setText(aux);
    ...
    private void CargarForms() {
        ...
        ListaVIVIENDA.add(new String[]{ "titulito", "Factores de fragilidad",  "titulito"});
        ListaVIVIENDA.add(new String[]{ "tipologiaValpa", "Tipología",  "spinner"});
        ListaVIVIENDA.add(new String[]{ "noPisosValpa", "Número de pisos - Salt",  "spinner"});
        ListaVIVIENDA.add(new String[]{ "estadoValpa", "Estado - Separación de grietas (mm) - Scon",  "spinner"});
        ListaVIVIENDA.add(new String[]{ "vidaUtilValpa", "Vida útil - Tipología",  "spinner"});
        ListaVIVIENDA.add(new String[]{ "servicioValpa", "Años de servicio",  "edittext"});
        ...
        ListaRocasDiscont.add(new String[]{"PersistenciaDiscont", "Persistencia",  "spinner"});
        ListaRocasDiscont.add(new String[]{"AnchoAberDiscont", "Ancho de Abertura",  "spinner"});
...
//        ListaSuelos.add(new String[]{"dirimbricacionmatriz2", "Dirección Imbricación Matriz 2",  "edittext"});
        ...
        ListaCATALOGO.add(new String[]{"Causado por Intervención Antrópica","spinner","intervencionAnt"});
        ListaCATALOGO.add(new String[]{"IMPORTANCIA","spinner","IMPORTANC"});
        ListaCATALOGO.add(new String[]{"ENCUESTADOR","spinner","ENCUESTAD"});
        ...
        ListaCATALOGO.add(new String[]{"CONFIABILIDAD FECHA EVENTO","spinner","ConfiFecha"});
...
//        ListaCATALOGO.add(new String[]{"SIMMA","edittext","COD_SIMMA"});
        ...
        ListaCATALOGO.add(new String[]{"Vereda",  "spinner",  "VEREDA"});
...
//        ListaCATALOGO.add(new String[]{"FOTOGRAFÍAS AÉREAS","edittext","FTE_INFSEC"});
        ...
        ListaINVENTARIO.add(new String[]{"Causado por Intervención Antrópica","spinner","intervencionAnt"});
        ListaINVENTARIO.add(new String[]{"IMPORTANCIA","spinner","IMPORTANC"});
        ListaINVENTARIO.add(new String[]{"ENCUESTADOR","spinner","ENCUESTAD"});
        ...
        ListaINVENTARIO.add(new String[]{"CONFIABILIDAD FECHA EVENTO","spinner","ConfiFecha"});
...
//        ListaINVENTARIO.add(new String[]{"SIMMA","edittext","COD_SIMMA"});
        ...
        ListaINVENTARIO.add(new String[]{"Vereda",  "spinner",  "VEREDA"});
